...
namespace MongoGUICtl.Module
{
	public partial class ctlMongodump : UserControl
	{
		...
		public ctlMongodump(ResourceLib.GUIConfig GUIConfig = null)
		{
			InitializeComponent();
			if (GUIConfig == null)
				return;
			if (!configuration.guiConfig.IsUseDefaultLanguage) {
				...
				lblPort.Text = configuration.guiConfig.MStringResource.GetText(StringResource.TextType.DosCommand_Tab_Backup_Port);
