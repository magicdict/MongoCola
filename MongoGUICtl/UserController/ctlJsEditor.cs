	...
	public partial class ctlJsEditor : UserControl
	{
		...
		private void JsEditor_Load(object sender, EventArgs e)
		{
			...
			if (!configuration.guiConfig.IsUseDefaultLanguage) {
				...
				SaveStripButton.Text = configuration.guiConfig.MStringResource.GetText(StringResource.TextType.Common_Save);
				EditDocStripButton.Text = configuration.guiConfig.MStringResource.GetText(StringResource.TextType.Common_Edit);
			...
			txtJavaScript.GotFocus += (x, y) => { 
				RuntimeMongoDBContext.SelectObjectTag = strDBtag;
			};
		}
