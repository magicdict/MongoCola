...
namespace MongoGUICtl
{
    public static class FillMongoDB
    {
        ...
        public  static void FillDataBaseStatusToList(ListView lstSvr,Dictionary<String, MongoServer> _mongoConnSvrLst)
        {
            ...
            {
                lstSvr.Columns.Add(
                    configuration.guiConfig.MStringResource.GetText(StringResource.TextType.DataBase_Status_DataBaseName));
                lstSvr.Columns.Add(
                    configuration.guiConfig.MStringResource.GetText(StringResource.TextType.DataBase_Status_CollectionCount));
                lstSvr.Columns.Add(
                    configuration.guiConfig.MStringResource.GetText(StringResource.TextType.DataBase_Status_DataSize));
                lstSvr.Columns.Add(
                    configuration.guiConfig.MStringResource.GetText(StringResource.TextType.DataBase_Status_FileSize));
                lstSvr.Columns.Add(
                    configuration.guiConfig.MStringResource.GetText(StringResource.TextType.DataBase_Status_IndexCount));
                lstSvr.Columns.Add(
                    configuration.guiConfig.MStringResource.GetText(StringResource.TextType.DataBase_Status_IndexSize));
                lstSvr.Columns.Add(
                    configuration.guiConfig.MStringResource.GetText(StringResource.TextType.DataBase_Status_ObjectCount));
                lstSvr.Columns.Add(
                    configuration.guiConfig.MStringResource.GetText(StringResource.TextType.DataBase_Status_StorageSize));
            }
            foreach (string mongoSvrKey in _mongoConnSvrLst.Keys)
            {
                try
            ...
            public int Compare(object x, object y)
            {
                ...
                switch (mCompareMethod)
                {
                    ...
                    case SortMethod.SizeCompare:
                        rtnCompare =
                            (int)
                                (Common.Utility.ReconvSize(lstX.SubItems[ColumnToSort].Text) -
                                 Common.Utility.ReconvSize(lstY.SubItems[ColumnToSort].Text));
                        break;
