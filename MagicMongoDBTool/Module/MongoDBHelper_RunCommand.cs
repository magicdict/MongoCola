...
namespace MagicMongoDBTool.Module
{
    public static partial class MongoDBHelper
    {
        ...
        public static CommandResult ServerStatus(MongoServer mongosvr) 
        {
            ...
            return ExecuteMongoSvrCommand(serverStatusCommand, mongosvr);    
        }
        /// <summary>
        /// 修复数据库
        /// </summary>
        ...
        /// <returns></returns>
        public static CommandResult RepairDataBase(MongoDatabase mongoDB)
        {
            var serverStatusCommand = new CommandDocument { { "repairDatabase", 1 } };
            return ExecuteMongoDBCommand(serverStatusCommand, mongoDB);
        }
