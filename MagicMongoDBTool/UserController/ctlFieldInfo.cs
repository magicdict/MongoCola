    ...
    public partial class ctlFieldInfo : UserControl
    {
        ...
        public MongoDBHelpler.QueryFieldItem QueryFieldItem {
            ...
            get { 
                ...
                if (this.radNoSort.Checked) { rtn.sortType = MongoDBHelpler.SortType.NoSort; }
                if (this.radSortAcs.Checked) { rtn.sortType = MongoDBHelpler.SortType.Ascending; }
                if (this.radSortDes.Checked) { rtn.sortType = MongoDBHelpler.SortType.Descending; }
                return rtn;
            }
