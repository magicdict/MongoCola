...
namespace MongoCola
{
    partial class frmOption
    {
        ...
        private void InitializeComponent()
        {
        	...
        	this.ctlFilePickerMongoBinPath = new Common.ctlFilePicker();
        	...
        	this.lblExectablePath.Size = new System.Drawing.Size(0, 15);
        	...
        	this.ctlFilePickerMongoBinPath.PickerType = Common.ctlFilePicker.DialogType.Directory;
