...
{
    public partial class frmPasswordInputBox : Form
    {
        /// <summary>
        ///     return result
        /// </summary>
        ...
        private void btnSwithPassword_Click(object sender, EventArgs e)
        {
            if (txtResult.PasswordChar == '*')
            {
                txtResult.PasswordChar = char.MinValue;
            }else
            {
                txtResult.PasswordChar = '*';
            }
        }
    }
}